package com.example.administrator.scorerecode.adapter;
...
import com.example.administrator.scorerecode.R;
...
public class ScoreAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        // 2.获取视图中的组建
        TextView textView = v.findViewById(R.id.EN);
        TextView textView1 = v.findViewById(R.id.Score);

        //获得列表项的数据项数据
        Score score = list.get(i);

        //3.给组建赋值
        textView.setText(score.EN);
        textView1.setText(score.SCORE+"分");
